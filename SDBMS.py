...
class Password:
    ...
    def __init__(self, root):
        ...
        manage_student_btn = Button(Dash_Frame, bg="#00A1E4", text="Student", fg="#F0EDEE",
                                    ...
                                    command=self.student_btn).grid(row=0, column=0, padx=2, pady=0, sticky="w")

        manage_employee_btn = Button(Dash_Frame, bg="#00A1E4", fg="#F0EDEE", text="Employee",
                                     font=("Arial", 9, "bold"), relief=GROOVE, width=11, pady=20,
                                     command=self.employee_btn).grid(row=1, column=0, padx=2, pady=2, sticky="w")
    ...
    def change_pass(self):
        ...
        if self.username.get() == "" or self.old_password.get() == ""or self.new_password.get() == "":messagebox.showerror("Error", "Fields Missing")
         ...
         connect = pymysql.connect("localhost", "root", "", "student")
         curr = connect.cursor()
...
class Department:
    ...
    def __init__(self, root):
        ...
        department_btn = Button(Dash_Frame, text="Department", bg="#00A1E4", fg="#F0EDEE",
                                font=("Arial", 9, "bold"), relief=GROOVE, width=11, pady=20).grid(row=2, column=0, padx=2, pady=2, sticky="w")

        password_btn = Button(Dash_Frame, text="Password", bg="#00A1E4", fg="#F0EDEE",
                              font=("Arial", 9, "bold"), relief=GROOVE, width=11, pady=20, command=self.pass_btn).grid(row=3, column=0, padx=2, pady=2, sticky="w")
        ...
        add_btn = Button(btn_frame, text="Add", width=10, bg="#00A1E4", fg="#FFFCF9",
                         font=("Arial", 10, "bold"), command=self.add_department).grid(row=0, column=0, padx=5, pady=10)
        ...
        logout_btn = Button(Detail_Frame, text="Log Out", bg="#00A1E4", fg="#FFFCF9",
                            font=("Arial", 10, "bold"), relief=GROOVE, width=10, pady=5, command=self.logout).grid(row=0, column=7, padx=690, pady=10)
...
class Employee:
    ...
    def __init__(self, root):
        ...
        manage_employee_btn = Button(Dash_Frame, bg="#00A1E4", fg="#F0EDEE", text="Employee",
                                     font=("Arial", 9, "bold"), relief=GROOVE, width=11, pady=20).grid(row=1, column=0, padx=2, pady=2, sticky="w")
        ...
        add_btn = Button(btn_frame, text="Add", width=10, bg="#00A1E4", fg="#FFFCF9",
                         font=("Arial", 10, "bold"), command=self.add_employee).grid(row=0, column=0, padx=5, pady=10)
        ...
        show_all_btn = Button(Detail_Frame, text="Show All", bg="#00A1E4", fg="#FFFCF9",
                              font=("Arial", 10, "bold"), relief=GROOVE, width=10, pady=5, command=self.show_data).grid(row=0, column=6, padx=10, pady=10)

        logout_btn = Button(Detail_Frame, text="Log Out", bg="#00A1E4", fg="#FFFCF9",
                            font=("Arial", 10, "bold"), relief=GROOVE, width=10, pady=5, command=self.logout).grid(row=0, column=7, padx=10, pady=10)
        ...
        self.Table = ttk.Treeview(Table_Frame, columns=("Emp-ID", "Department", "Name",
                                                        "Email-ID", "Address", "Contact No", "Position"),
...
def get_fields(self, event):
    ...
    def update(self):
        if self.emp_id.get() == "" or self.ename.get() == "" or self.email_id.get() == ""or self.position.get() == "" or self.dept.get() == "" or self.contact.get() == ""or self.txt_address.get('1.0', END) == "":
            ...
            curr.execute("UPDATE EMPLOYEE SET dept_id=%s,ename=%s,email_id=%s,address=%s,contact_no = % s, position = % s whereemp_id = % s",(
...
class Student:
    ...
    def __init__(self, root):
        ...
        title = Label(self.root, text="CPP Secrets Student Management System"
                      , bd=10, relief=RIDGE, font=("Arial", 43, "bold"), bg="#00A1E4", fg="#FFFCF9")
        ...
        manage_student_btn = Button(Dash_Frame, bg="#00A1E4", text="Student", fg="#F0EDEE", font=("Arial", 9, "bold"),relief=RIDGE, width=11, pady=20).grid(row=0, column=0, padx=2, pady=0, sticky="w")

        manage_employee_btn = Button(Dash_Frame, bg="#00A1E4", fg="#F0EDEE", text="Employee", font=("Arial", 9, "bold"),relief=RIDGE, width=11, pady=20, command=self.employee_btn).grid(row=1, column=0,padx=2, pady=2,sticky="w")

        department_btn = Button(Dash_Frame, text="Department", bg="#00A1E4", fg="#F0EDEE", font=("Arial", 9, "bold"),relief=RIDGE, width=11, pady=20, command=self.dept_btn).grid(row=2, column=0, padx=2,pady=2, sticky="w")

        password_btn = Button(Dash_Frame, text="Password", bg="#00A1E4", fg="#F0EDEE", font=("Arial", 9, "bold"),relief=RIDGE, width=11, pady=20, command=self.pass_btn).grid(row=3, column=0, padx=2,pady=2, sticky="w")

        exit_btn = Button(Dash_Frame, text="Exit", bg="#00A1E4", fg="#F0EDEE", font=("Arial", 9, "bold"), relief=RIDGE,width=11, pady=20, command=self.logout).grid(row=4, column=0, padx=2, pady=2, sticky="w")
        ...
        txt_Roll = Entry(Manage_Frame, textvariable=self.roll_no, font=("Arial", 15, "bold"),bd=5, relief=RIDGE)
        txt_Roll.grid(row=1, column=1, pady=10, padx=20, sticky="w")

        lbl_name = Label(Manage_Frame, text="Name.", bg="#F0EDEE", fg="black",font=("Arial", 15, "bold"))
        lbl_name.grid(row=2, column=0, pady=10, padx=20, sticky="w")

        txt_name = Entry(Manage_Frame, textvariable=self.name, font=("Arial", 15, "bold"),bd=5, relief=RIDGE)
        txt_name.grid(row=2, column=1, pady=10, padx=20, sticky="w")

        lbl_email = Label(Manage_Frame, text="Email-ID.", bg="#F0EDEE", fg="black",font=("Arial", 15, "bold"))
        lbl_email.grid(row=3, column=0, pady=10, padx=20, sticky="w")

        txt_email = Entry(Manage_Frame, textvariable=self.email_id,font=("Arial", 15, "bold"), bd=5, relief=RIDGE)
        txt_email.grid(row=3, column=1, pady=10, padx=20, sticky="w")
        ...
        txt_contact = Entry(Manage_Frame, textvariable=self.contact,font=("Arial", 15, "bold"), bd=5, relief=RIDGE)
        txt_contact.grid(row=5, column=1, pady=10, padx=20, sticky="w")

        lbl_DOB = Label(Manage_Frame, text="D.O.B", bg="#F0EDEE", fg="black",font=("Arial", 15, "bold"))
        lbl_DOB.grid(row=6, column=0, pady=10, padx=20, sticky="w")

        self.txt_DOB = Entry(Manage_Frame, textvariable=self.dob, font=("Arial", 15, "bold"), bd=5, relief=RIDGE)
        ...
        txt_search = Entry(Detail_Frame, width=20, textvariable=self.search_field, font=("Arial", 10, "bold"), bd=5,relief=RIDGE)
        txt_search.grid(row=0, column=2, pady=10, padx=20, ipady=4, sticky="w")

        search_btn = Button(Detail_Frame, text="Search", bg="#00A1E4", fg="#FFFCF9", font=("Arial", 10, "bold"),relief=RIDGE, width=10, pady=5, command=self.search_data).grid(row=0, column=5, padx=10,pady=10)

        show_all_btn = Button(Detail_Frame, text="Show All", bg="#00A1E4", fg="#FFFCF9", font=("Arial", 10, "bold"),relief=RIDGE, width=10, pady=5, command=self.show_data).grid(row=0, column=6, padx=10,pady=10)

        logout_btn = Button(Detail_Frame, text="Log Out", bg="#00A1E4", fg="#FFFCF9", font=("Arial", 10, "bold"),relief=RIDGE, width=10, pady=5, command=self.logout).grid(row=0, column=7, padx=10, pady=10)
        ...
        X_scroll = Scrollbar(Table_Frame, orient=HORIZONTAL)
        Y_scroll = Scrollbar(Table_Frame, orient=VERTICAL)
        self.Table = ttk.Treeview(Table_Frame, columns=("Roll-No", "Name", "Email-ID","Gender", "D.O.B", "Address", "Contact No"),xscrollcommand=X_scroll.set,yscrollcommand=Y_scroll.set)
    ...
    def add_student(self):
        if self.roll_no.get() == "" or self.name.get() == "" or self.email_id.get() == "" or self.gender.get() == "" or self.dob.get() == "" or self.contact.get() == "" or self.txt_address.get() == "":
            messagebox.showerror("Error", "All Fields are Required")
    ...
    def update(self):
        if self.roll_no.get() == "" or self.name.get() == "" or self.email_id.get() == "" or self.gender.get() == "" or self.dob.get() == "" or self.contact.get() == "" or self.txt_address.get(
            ...
            curr.execute(
                "UPDATE STUDENT SET Sname=%s,email_id=%s,gender=%s,dob=%s,address = %s, contact_no = %s whereroll_no = %s",
                (self.name.get(), self.email_id.get(), self.gender.get(), self.dob.get(),
                 self.txt_address.get('1.0', END), self.contact.get(), self.roll_no.get()))
    ...
    def foc_in(self, event):
        if self.txt_DOB['fg'] == "grey":
            ...
            self.txt_DOB['fg'] = "grey" #change, could be wrong

    def foc_out(self, event):
        if not self.txt_DOB.get():
            self.txt_DOB.get().self.put_placeholder() #change, could be wrong
...
class Login:
    ...
    def __init__(self, root):
        ...
        login_btn = Button(btn_frame, text="Login", width=20, relief=GROOVE, bg="#00A1E4",
                           font=("Arial", 10, "bold"), command=self.validate_user).grid(row=0, column=0, padx=0, pady=10)
